...
const styles = StyleSheet.create({
  ...
  posterLine: { fontFamily: fonts.body, fontSize: 11.5, color: colors.saddle, marginTop: 4 },
  ...
  fbLink: { fontFamily: fonts.bodySemiBold, fontSize: 12.5, color: colors.espresso, marginTop: 8, textDecorationLine: 'underline' },
